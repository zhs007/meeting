...
def test_openai_exact_input_device_name_match() -> None:
...
def test_openai_missing_input_device_fails_explicitly() -> None:
...
def test_openai_missing_output_device_fails_explicitly() -> None:
...
def test_openai_no_implicit_default_device_selection() -> None:
